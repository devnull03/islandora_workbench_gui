...
#
# Produces:
#   dist/Islandora Workbench.app
#   dist/Islandora-Workbench-<version>-universal.dmg
#
...
app_name="Islandora Workbench"
executable="islandora-workbench"
dist="$root/dist"
...
# ---- .dmg ------------------------------------------------------------------
dmg="$dist/Islandora-Workbench-${VERSION}-universal.dmg"
